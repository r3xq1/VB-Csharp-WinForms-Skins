...
class BloodyTheme : ThemeContainer154
{
    private Color Border;
    private Brush TextBrush;
    private ColorBlend cblend = new ColorBlend(2);
    ...
    protected override void PaintHook()
    {
        ...
        // Диагональные линии
        var hatchBrush = new HatchBrush(HatchStyle.DarkDownwardDiagonal, Color.FromArgb(200, 45, 0, 0), Color.Black);

        // Рисует фон
        G.FillRectangle(new SolidBrush(BackColor), new Rectangle(6, 24, Width - 12, Height - 30));

        // Рисует диагональные линии
        G.FillRectangle(hatchBrush, new Rectangle(6, 24, Width - 12, Height - 30));
...
public class BloodyButton : ThemeControl154
{
    ...
    private Pen border;
    private ColorBlend bicouleur = new ColorBlend(2);
    ...
    protected override void PaintHook()
    {
        ...
        switch (State)
        {
            case MouseState.None:
                bicouleur.Colors[0] = Color.FromArgb(255, 40, 0, 0); // Dark Red
                bicouleur.Colors[1] = Color.FromArgb(240, 90, 0, 0); // Red
            ...
            case MouseState.Over:
                bicouleur.Colors[0] = Color.FromArgb(235, 40, 0, 0); // Dark Red
                bicouleur.Colors[1] = Color.FromArgb(200, 90, 0, 0); // Red
                bicouleur.Positions[0] = 0;
                bicouleur.Positions[1] = 1;
                DrawGradient(bicouleur, new Rectangle(0, 0, Width, Height));
                bicouleur.Colors[0] = Color.FromArgb(0, 0, 0, 0);
            ...
            case MouseState.Down:
                bicouleur.Colors[0] = Color.FromArgb(205, 40, 0, 0); // Dark Red
                bicouleur.Colors[1] = Color.FromArgb(185, 90, 0, 0); // Red
                bicouleur.Positions[0] = 0;
                bicouleur.Positions[1] = 1;
                DrawGradient(bicouleur, new Rectangle(0, 0, Width, Height));
                bicouleur.Colors[0] = Color.FromArgb(0, 0, 0, 0);
