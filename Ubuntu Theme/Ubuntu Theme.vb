...
Public Class UbuntuTheme : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(60, 60, 60))), RoundRect(Body, 1))
        ...
        G.DrawPath(Pens.Black, RoundRect(FixBottom, 1))
    ...
    Protected Overrides Sub OnCreateControl()
        ...
        Dock = DockStyle.Fill
    End Sub
    Private Sub UbuntuTheme1_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Select Case State
            Case MouseState.None
                ...
                G.FillPath(lgb, RoundRect(ClientRectangle, 3))
                G.DrawPath(p, RoundRect(ClientRectangle, 3))
...
Public Class UbuntuGroupBox : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        G.FillPath(bodygrade, RoundRect(New Rectangle(0, 12, Width - 1, Height - 15), 1))

        Dim outerBorder As New LinearGradientBrush(ClientRectangle, Color.FromArgb(50, 50, 50), Color.DimGray, 90S)
        G.DrawPath(New Pen(outerBorder), RoundRect(New Rectangle(0, 12, Width - 1, Height - 15), 1))

        Dim lbb As New LinearGradientBrush(TopBar, Color.FromArgb(87, 86, 81), Color.FromArgb(60, 59, 55), 90S)
        G.FillPath(lbb, RoundRect(TopBar, 1))

        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(50, 50, 50))), RoundRect(TopBar, 2))
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        G.DrawPath(New Pen(Color.FromArgb(255, 207, 188)), RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 1))
        G.DrawPath(New Pen(Color.FromArgb(255, 207, 188)), RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 2))
        G.DrawPath(New Pen(Color.FromArgb(205, 87, 40)), RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 2))
        G.DrawPath(New Pen(Color.FromArgb(205, 87, 40)), RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 3))
