...
Class YouTubeButton
    ...
    'Fill the button
    Sub FillButton(rctBounds As Rectangle, clrOne As Color, clrTwo As Color)
...
Class YouTubeTextBox
    ...
    Sub TextGotFocus(sender As Object, e As System.EventArgs)
        IsFocused = True
    ...
    Sub TextLostFocus(sender As Object, e As System.EventArgs)
        IsFocused = False
    ...
    Sub DrawShadowsFocused(rctButtonBorder As Rectangle)
        'Vertical
    ...
    Sub DrawShadows(rctButtonBorder As Rectangle)
        'Vertical
...
Class YouTubeCheckbox
    ...
    Private Sub DrawBoxBorders(blnHover As Boolean)
        If blnHover Then
