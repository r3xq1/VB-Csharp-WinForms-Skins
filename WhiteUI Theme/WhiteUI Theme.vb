...
Public Class DrawUtils
    ...
    Public Sub FillGradientBeam(g As Graphics, Col1 As Color, Col2 As Color, rect As Rectangle, align As GradientAlignment)
    ...
    End Sub
    Public Sub DrawShadowPath(G As Graphics, ColBlend As ColorBlend, Path As GraphicsPath)
        ...
        End Using
    End Sub
    Public Sub DrawShadowEllipse(G As Graphics, col As Color, Path As Rectangle)
    ...
    End Function
    Public Sub DrawTextWithShadow(G As Graphics, ContRect As Rectangle, Text As String, TFont As Font, TAlign As HorizontalAlignment, TColor As Color, BColor As Color)
    ...
    End Sub
    Public Sub DrawText(G As Graphics, ContRect As Rectangle, Text As String, TFont As Font, TAlign As HorizontalAlignment, TColor As Color)
    ...
    Public Function RoundRect(Rectangle As Rectangle, Curve As Integer) As GraphicsPath
        ...
        Return Path
    End Function
    Public Function RoundedTopRect(Rectangle As Rectangle, Curve As Integer) As GraphicsPath
