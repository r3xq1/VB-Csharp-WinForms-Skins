...
public class ClsAnomTheme : ThemeContainer154
{
    ...
    {
        G.Clear(Border);
        var LGB = new LinearGradientBrush(new Rectangle(1, 1, Width - 2, Height - 2),
                                           Color.FromArgb(255, 222, 222, 222),
                                           Color.FromArgb(255, 170, 170, 170),
                                           45.0F);
        var HB = new HatchBrush(HatchStyle.LightDownwardDiagonal, Color.FromArgb(100, Color.Gray), Color.Transparent);
        ...
        int TextXPos = FindForm().ShowIcon ? 30 : 6;
...
public class AnomButton : ThemeControl154
{
    ...
    protected override void PaintHook()
    {
        var LGBNone = new LinearGradientBrush(new Rectangle(1, 1, Width - 2, Height - 2),
                                               Color.FromArgb(255, 222, 222, 222),
                                               Color.FromArgb(255, 200, 200, 200),
                                               90.0F);
        var LGBDown = new LinearGradientBrush(new Rectangle(1, 1, Width - 2, Height - 2),
                                               Color.FromArgb(255, 200, 200, 200),
                                               Color.FromArgb(255, 222, 222, 222),
                                               90.0F);
        ...
        var HB = new HatchBrush(HatchStyle.LightDownwardDiagonal, Color.FromArgb(80, Color.Gray), Color.Transparent);
        G.FillRectangle(HB, new Rectangle(1, 1, Width - 2, Height - 2));
...
public class AnomGroupBox : ThemeContainer154
{
    ...
    {
        G.Clear(BackColor);
        var LGB = new LinearGradientBrush(new Rectangle(1, 1, Width - 2, Height - 1),
                                           Color.FromArgb(255, 222, 222, 222),
                                           Color.FromArgb(255, 200, 200, 200),
                                           90.0F);
        var HB = new HatchBrush(HatchStyle.LightDownwardDiagonal, Color.FromArgb(80, Color.Gray), Color.Transparent);
...
public class AnomCheckBox : ThemeControl154
{
    ...
    public AnomCheckBox()
    {
        BackColor = Color.Transparent; // Установите прозрачный фон
        Height = 18;
    }
    ...
    {
        base.OnClick(e);
        Checked = !Checked; // Изменение состояния чекбокса
    }
    ...
    protected override void OnTextChanged(EventArgs e)
    {
        ...
        Width = 20 + textSize; // Корректировка ширины по тексту
    }

    protected override void PaintHook()
    {
        G.Clear(BackColor); // Сохранение фона
        var HB = new HatchBrush(HatchStyle.LightDownwardDiagonal, Color.FromArgb(80, Color.Gray), Color.Transparent);
        var LGB = new LinearGradientBrush(new Rectangle(1, 1, 16, 16),
                                           Color.FromArgb(255, 222, 222, 222),
                                           Color.FromArgb(255, 200, 200, 200),
                                           90.0F);
        ...
        G.DrawString(Text, Font, Brushes.Black, 20, 2); // Отрисовка текста
    }
}
public class AnomTrippleCheckBox : ThemeControl154
{
    ...
    protected override void PaintHook()
    {
        ...
        if (Checked == 1)
        {
            G.DrawString("a", new Font("Webdings", 13), Brushes.Black, new Point(2, 2)); // Отрисовка галочки
        }
        else if (Checked == 2)
        {
            G.FillRectangle(Brushes.Black, 5, 5, 8, 8); // Заполненный квадрат
        }
...
public class AnomRadiobutton : ThemeControl154
{
    ...
    protected override void OnClick(EventArgs e)
    {
        ...
        {
            if (c is AnomRadiobutton)
            {
                ((AnomRadiobutton)c).Checked = false;
            }
        }
        _Checked = true;
    }
    ...
    protected override void PaintHook()
    {
        ...
        if (_Checked)
        {
            G.FillEllipse(new SolidBrush(Color.Black), 4, 4, 8, 8); // Заполненный внутренний круг
        }

        G.DrawString(Text, Font, Brushes.Black, 18, 2); // Отрисовка текста
    }
