...
Module ConversionFunctions
    Function ToBrush(A As Integer, R As Integer, G As Integer, B As Integer) As Brush
        Return New SolidBrush(Color.FromArgb(A, R, G, B))
    End Function
    Function ToBrush(R As Integer, G As Integer, B As Integer) As Brush
        Return New SolidBrush(Color.FromArgb(R, G, B))
    End Function
    Function ToBrush(A As Integer, C As Color) As Brush
        Return New SolidBrush(Color.FromArgb(A, C))
    End Function
    Function ToBrush(Pen As Pen) As Brush
        Return New SolidBrush(Pen.Color)
    End Function
    Function ToBrush(Color As Color) As Brush
        Return New SolidBrush(Color)
    End Function
    Function ToPen(A As Integer, R As Integer, G As Integer, B As Integer) As Pen
        Return New Pen(New SolidBrush(Color.FromArgb(A, R, G, B)))
    End Function
    Function ToPen(R As Integer, G As Integer, B As Integer) As Pen
        Return New Pen(New SolidBrush(Color.FromArgb(R, G, B)))
    End Function
    Function ToPen(A As Integer, C As Color) As Pen
        Return New Pen(New SolidBrush(Color.FromArgb(A, C)))
    End Function
    Function ToPen(Brush As SolidBrush) As Pen
...
Module Shapes
    Public Function Triangle(Location As Point, Size As Size) As Point()
...
Public Class SkyDarkForm
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        ...
        G.DrawString(Text, Font, ToBrush(113, 170, 186),
                     New Rectangle(New Point(T1.X + 4, T1.Y), New Size(T1.Width - 40, T1.Height)),
    ...
    Private Sub Exim_Click(sender As Object, e As System.EventArgs) Handles Exim.Click
        Parent.FindForm.Close()
    End Sub

    Private Sub Maxim_Click(sender As Object, e As System.EventArgs) Handles Maxim.Click
...
Public Class SkyDarkCombo
    ...
    Private Sub SkyDarkCombo_TextChanged(sender As Object, e As System.EventArgs) Handles Me.TextChanged
        Invalidate()
    End Sub
End Class
