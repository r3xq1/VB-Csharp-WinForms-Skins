...
Class VTabControl
    ...
    Private DrawGradientBrush2, DrawGradientBrushPen As LinearGradientBrush
    ...
    End Sub
    Sub DoAnimationScrollDown(Control1 As Control, Control2 As Control)
    ...
    Protected Overrides Sub OnDeselecting(e As TabControlCancelEventArgs)
        OldIndex = e.TabPageIndex
    End Sub
    Sub DoAnimationScrollUp(Control1 As Control, Control2 As Control)
        Dim G As Graphics = Control1.CreateGraphics()
        Dim P1 As New Bitmap(Control1.Width, Control1.Height)
        Dim P2 As New Bitmap(Control2.Width, Control2.Height)
        Control1.DrawToBitmap(P1, New Rectangle(0, 0, Control1.Width, Control1.Height))
